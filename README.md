...
## Introduction
This is a library for handling block state IDs according to the Minecraft protocol. It is designed to fetch [Block State](https://minecraft.wiki/w/Java_Edition_protocol/Entity_metadata#Metadata_type:Block_State) information.

## Usage
To use this library, you can download the JAR as a dependency from [releases](https://github.com/lonlf/BlockStateLib/releases).  
Alternatively, use the repository as a dependency from [here](https://jitpack.io/#lonlf/BlockStateLib).

### Example
```JAVA
public class TestExample {
    public static void main(String[] args){
        // 1. Initialize BlockStateLib. Requires your server version.
        ...
        // Empty metadata. This returns the default block state ID.
